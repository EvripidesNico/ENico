...
HD_PWD='C:/Users/Bulls/Desktop/Lab_5_at_lab.xpr/test_lab7_thing/test_lab7_thing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toppo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toppo.tcl
