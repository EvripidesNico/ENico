 ...
 */
unsigned int PING_GetDistance_P1(void);
 ...
 * @return      distance in mm
 */
unsigned int PING_GetDistance_P2(void);
...
/**
 * @function    PING_P1_NewDataAvailable(void)
 * @brief       Returns a static variable in file indicating new ping data available.
 * @return      1 if new data, 0 if data already read.
 */
uint8_t PING_P1_NewDataAvailable(void);

/**
 * @function    PING_P2_NewDataAvailable(void)
 * @brief       Returns a static variable in file indicating new ping data available.
 * @return      1 if new data, 0 if data already read.
 */
