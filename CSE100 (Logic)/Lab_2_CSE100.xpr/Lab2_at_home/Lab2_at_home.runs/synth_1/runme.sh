...
HD_PWD='C:/Users/Bulls/Desktop/Lab2_CSE100.xpr/Lab2_at_home/Lab2_at_home.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainAdder.tcl
