...
HD_PWD='C:/Users/Bulls/Desktop/Lab2_at_home/Lab2_at_home.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mainAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mainAdder.tcl -notrace
