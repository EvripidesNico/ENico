...
HD_PWD='C:/Users/Bulls/Desktop/Lab_5_at_lab.xpr/test_lab7_thing/test_lab7_thing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log toppo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source toppo.tcl -notrace
